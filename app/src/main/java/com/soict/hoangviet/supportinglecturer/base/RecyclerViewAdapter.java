package com.soict.hoangviet.supportinglecturer.base;
...
//        notifyItemRangeRemoved(0, itemCount);
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, final int viewType) {
        ...
        final RecyclerView.ViewHolder viewHolder = solvedOnCreateViewHolder(itemView, parent, viewType);
    ...
    protected RecyclerView.ViewHolder solvedOnCreateViewHolder(View itemView, ViewGroup parent, int viewType) {
        if (viewType == VIEW_TYPE_NORMAL) {
            return initNormalViewHolder(itemView, parent);
        }
        return null;
    }
    ...
    protected abstract RecyclerView.ViewHolder initNormalViewHolder(View itemView, ViewGroup parent);
