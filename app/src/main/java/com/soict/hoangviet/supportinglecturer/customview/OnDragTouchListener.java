...
public class OnDragTouchListener implements View.OnTouchListener {
    ...
    public interface OnDragActionListener {
         ...
         * @param view The view dragged
         */
        void onDragEnd(View view, boolean isClickDetected, float lastPositionX, float lastPositionY);
    }
...
//                    }
                    lastTouchTime = now;
                    onDragFinish(isClickDetected, mView.getX(), mView.getY());
                    break;
    ...
    private void onDragFinish(boolean isClickDetected, float lastPositionX, float lastPositionY) {
        if (mOnDragActionListener != null) {
            mOnDragActionListener.onDragEnd(mView, isClickDetected, lastPositionX, lastPositionY);
        }
